...
const taskController = require('../apis/tasks/taskController')
...
//task
router.post('/task/all', taskController.getAll)
router.post('/task/single', taskController.getSingle)
router.post('/task/add', helper.uploadImageFun.single('task_image'), taskController.addTask)
router.post('/task/update', helper.uploadImageFun.single('task_image'), taskController.updateTask)
